...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='ASformer')

    # basic config
    parser.add_argument('--flag', type=int, default=1, help='flag')
    parser.add_argument('--is_training', type=int, default=1, help='status')
    parser.add_argument('--model_id', type=str, default='test', help='model id')
    parser.add_argument('--model', type=str, default='ASformer',
                        help='model name, options: [ASformer, iInformer, iReformer, iFlowformer, iFlashformer]')

    # data loader
    parser.add_argument('--data', type=str, default='custom', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./dataset/exchange_rate/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='exchange_rate.csv', help='data csv file')
